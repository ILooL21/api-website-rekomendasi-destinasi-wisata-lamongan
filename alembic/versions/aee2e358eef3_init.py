...
Revision ID: aee2e358eef3
Revises: 
Create Date: 2025-06-08 21:03:11.848725
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('Selesai', 'Belum Dibalas', name='status_email'), nullable=False),
    ...
    sa.Column('deskripsi_tiket', sa.Text(), nullable=True),
    sa.Column('link_tiket', sa.String(), nullable=True),
    ...
    sa.Column('nama_tempat_wisata', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['id_rekomendasi'], ['rekomendasi_wisata.id_rekomendasi'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
